...
function useHydrated() {
  return o$1.useSyncExternalStore(subscribe, () => true, () => false);
}
function subscribe() {
  return () => {
  };
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-D91icvrU.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BL8uHQDh.js").then((n2) => n2.q),
    import("./start-Dy-fPebW.js"),
