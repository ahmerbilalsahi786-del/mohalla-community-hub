...
var Route$h = class Route extends BaseRoute {
  ...
  */
  constructor(options) {
    ...
    this.Link = o.forwardRef((props, ref) => {
...
const appCss = "/assets/styles-Vn0PfcgQ.css";
...
const $$splitComponentImporter$f = () => import("./auth--bdNZtGR.js");
const Route$f = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Sign in or create an account to join your Mohalla community."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./route-CDMgafMg.js");
...
const $$splitComponentImporter$d = () => import("./index-BHKtJwDi.js");
const Route$d = createFileRoute("/_authenticated/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your Mohalla community at a glance."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./volunteer-C1W6gzJA.js");
const Route$c = createFileRoute("/_authenticated/volunteer")({
  head: () => ({
    meta: [{
      title: "Volunteer — Mohalla"
    }, {
      name: "description",
      content: "Volunteer opportunities in your Mohalla community."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./settings-BVi7zaPe.js");
const Route$b = createFileRoute("/_authenticated/settings")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Manage your Mohalla account settings."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./safety-C620SGL5.js");
const Route$a = createFileRoute("/_authenticated/safety")({
  head: () => ({
    meta: [{
      title: "Safety & Alerts — Mohalla"
    }, {
      name: "description",
      content: "Community safety reports and alerts."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./polls-Cpq9kJ0J.js");
const Route$9 = createFileRoute("/_authenticated/polls")({
  head: () => ({
    meta: [{
      title: "Polls — Mohalla"
    }, {
      name: "description",
      content: "Community polls and resident feedback."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./places-BZAa6jNG.js");
const Route$8 = createFileRoute("/_authenticated/places")({
  head: () => ({
    meta: [{
      title: "Places — Mohalla"
    }, {
      name: "description",
      content: "Nearby places of interest for Mohalla residents."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./marketplace-DPXgETid.js");
const Route$7 = createFileRoute("/_authenticated/marketplace")({
  head: () => ({
    meta: [{
      title: "Marketplace — Mohalla"
    }, {
      name: "description",
      content: "Buy, sell, and give away items in your Mohalla community."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./help-C6Gi8Rux.js");
const Route$6 = createFileRoute("/_authenticated/help")({
  head: () => ({
    meta: [{
      title: "Help — Mohalla"
    }, {
      name: "description",
      content: "Help and support for Mohalla residents."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./feed-DBNrDYEA.js");
const Route$5 = createFileRoute("/_authenticated/feed")({
  head: () => ({
    meta: [{
      title: "Community Feed — Mohalla"
    }, {
      name: "description",
      content: "Your Mohalla community feed: posts, announcements, lost & found and more."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./events-TqunucQ4.js");
const Route$4 = createFileRoute("/_authenticated/events")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Upcoming Mohalla community events."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./community-COiiGNKW.js");
const Route$3 = createFileRoute("/_authenticated/community")({
  head: () => ({
    meta: [{
      title: "Community — Mohalla"
    }, {
      name: "description",
      content: "Mohalla members and neighborhood connections."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./announcements-CWQpWRJr.js");
const Route$2 = createFileRoute("/_authenticated/announcements")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Important Mohalla community announcements."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin-ZnPk1J1i.js");
const Route$1 = createFileRoute("/_authenticated/admin")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Mohalla community administration tools."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./marketplace._id-DSEg-MHX.js");
const Route2 = createFileRoute("/_authenticated/marketplace/$id")({
  head: () => ({
    meta: [{
      title: "Listing — Mohalla"
    }]
  }),
...
const AuthenticatedIndexRoute = Route$d.update({
  id: "/",
  path: "/",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedVolunteerRoute = Route$c.update({
  id: "/volunteer",
  path: "/volunteer",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedSafetyRoute = Route$a.update({
  id: "/safety",
  path: "/safety",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedPollsRoute = Route$9.update({
  id: "/polls",
  path: "/polls",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedPlacesRoute = Route$8.update({
  id: "/places",
  path: "/places",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedMarketplaceRoute = Route$7.update({
  id: "/marketplace",
  path: "/marketplace",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedHelpRoute = Route$6.update({
  id: "/help",
  path: "/help",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedFeedRoute = Route$5.update({
  id: "/feed",
  path: "/feed",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedCommunityRoute = Route$3.update({
  id: "/community",
  path: "/community",
  getParentRoute: () => AuthenticatedRouteRoute
});
...
const AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedPlacesRoute,
  AuthenticatedPollsRoute,
  AuthenticatedSafetyRoute,
