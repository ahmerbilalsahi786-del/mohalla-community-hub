...
const appCss = "/assets/styles-DBZUEknP.css";
...
const $$splitComponentImporter$5 = () => import("./auth-CYA5UzKz.js");
...
const $$splitComponentImporter$4 = () => import("./route-CIk-pbL_.js");
...
const $$splitComponentImporter$3 = () => import("./index-CLRa6PeO.js");
...
const $$splitComponentImporter$2 = () => import("./marketplace-IOTPLdxm.js");
const Route$2 = createFileRoute("/_authenticated/marketplace")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter$1 = () => import("./feed-URdfs8AQ.js");
const Route$1 = createFileRoute("/_authenticated/feed")({
  head: () => ({
    meta: [{
...
const $$splitComponentImporter = () => import("./marketplace._id-BBai-SP6.js");
...
const AuthenticatedMarketplaceRoute = Route$2.update({
  id: "/marketplace",
  path: "/marketplace",
  getParentRoute: () => AuthenticatedRouteRoute
});
const AuthenticatedFeedRoute = Route$1.update({
  id: "/feed",
  path: "/feed",
  getParentRoute: () => AuthenticatedRouteRoute
});
