...
const navItems = [
  ...
  { name: 'Events', icon: Calendar, href: '/events', badge: '3' },
  { name: 'Messages', icon: MessageSquare, href: '/messages', badge: '5' },
...
const bottomItems = [
  { name: 'Notifications', icon: Bell, href: '/notifications', badge: '8' },
