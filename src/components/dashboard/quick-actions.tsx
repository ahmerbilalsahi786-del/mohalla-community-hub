...
export function QuickActions() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border portal-soft-rule bg-card p-5 shadow-sm">
      <div className="relative">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          {actions.map((action) => (
            ...
            >
              <span className={cn('flex h-10 w-10 items-center justify-center rounded-lg bg-card shadow-xs', action.color)}>
                <action.icon
                  size={22}
